...
def main():
	...
	for Epo in range(epochs):
		...
		for k in range(TrainBatches):
			...
			for start in range(minibatch*k,minibatch*(k+1)):
				print(start)
				XXX,x2,y1,o1,a1=FP_InMem.TopInference(TI,start,cw,cb,lw,lb,RRAMRes,PulseRes)
		...
		for ick in range(TotalValid):
			XXX,x2,y1,o1,a1=FP_InMem.TopInference(VI,ick,cw,cb,lw,lb,RRAMRes,PulseRes)
	...
	for i in range(TotalTest):
		XXX,x2,y1,o1,a1=FP_InMem.TopInference(ti,i,cw,cb,lw,lb,RRAMRes,PulseRes)
